- [一\.Java概述](#--java--)
  * [1\.何为编程](#1-----)
  * [2\.什么是Java](#2----java)
  * [3\.jdk1\.5之后的三大版本](#3-jdk1-5-------)
  * [4\.JVM,JRE和JDK的关系](#4-jvm-jre-jdk---)
    + [(1)\.JVM](#-1--jvm)
    + [(2)\.JRE](#-2--jre)
    + [(3)\.JDK](#-3--jdk)
  * [5\.什么是跨平台性?原理是什么](#5--------------)
  * [6\.Java语言有哪些特点](#6-java-------)
  * [7\.什么是字节码?采用字节码的最大好处是什么](#7---------------------)
  * [8\.什么是Java程序的主类?应用程序和小程序的主类有何不同?](#8----java----------------------)
  * [9\.Java应用程序与小程序之间有那些差别](#9-java---------------)
  * [10\.Java和C++的区别](#10-java-c-----)
  * [11\.OracleJDK和OpenJDK的对比](#11-oraclejdk-openjdk---)
- [二\.基础语法](#------)
  * [1\.数据类型](#1-----)
    + [(1)\.Java有哪些数据类型](#-1--java-------)
    + [(2)\.switch是否能作用在byte上,是否能作用在long上,是否能作用在String上](#-2--switch------byte--------long--------string-)
    + [(3)\.用最有效率的方法计算2乘以8](#-3------------2--8)
    + [(4)\.Math\.round(11.5) 等于多少?Math\.round(-11.5)等于多少](#-4--math-round-115-------math-round--115-----)
    + [(5)\.float f=3.4;是否正确](#-5--float-f-34-----)
    + [(6)\.short s1 = 1; s1 = s1 + 1;有错吗?short s1 = 1; s1 += 1;有错吗](#-6--short-s1---1--s1---s1---1-----short-s1---1--s1----1----)
  * [2\.编码](#2---)
    + [(1)\.Java语言采用何种编码方案？有何特点？](#-1--java----------------)
  * [3\.注释](#3---)
    + [(1)\.什么Java注释](#-1----java--)
  * [4\.访问修饰符](#4------)
    + [(1)\.访问修饰符 public,private,protected,以及不写（默认）时的区别](#-1--------public-private-protected-------------)
  * [5\.运算符](#5----)
    + [(1)\.&和&&的区别](#-1---------)
  * [6\.关键字](#6----)
    + [(1)\.Java 有没有 goto](#-1--java-----goto)
    + [(2)\.final 有什么用？](#-2--final------)
    + [(3)\.final finally finalize区别](#-3--final-finally-finalize--)
    + [(4)\.this关键字的用法](#-4--this------)
    + [(5)\.super关键字的用法](#-5--super------)
    + [(6)\.this与super的区别](#-6--this-super---)
    + [(7)\.static存在的主要意义](#-7--static-------)
    + [(8)\.static的独特之处](#-8--static-----)
    + [(9)\.static应用场景](#-9--static----)
    + [(10)\.static注意事项](#-10--static----)
  * [7\.流程控制语句](#7-------)
    + [(1)\.break ,continue ,return 的区别及作用](#-1--break--continue--return-------)
    + [(2)\.在 Java 中，如何跳出当前的多重嵌套循环](#-2----java----------------)
- [三\.面向对象](#------)
  * [1\.面向对象概述](#1-------)
    + [(1)\.面向对象和面向过程的区别](#-1--------------)
  * [2\.面向对象三大特性](#2---------)
    + [(1)\.面向对象的特征有哪些方面](#-1--------------)
    + [(2)\.什么是多态机制？Java语言是如何实现多态的？](#-2----------java-----------)
    + [(3)\.面向对象五大基本原则是什么（可选）](#-3-------------------)
  * [3\.类与接口](#3-----)
    + [(1)\.抽象类和接口的对比](#-1-----------)
    + [(2)\.普通类和抽象类有哪些区别？](#-2---------------)
    + [(3)\.抽象类能使用 final 修饰吗？](#-3---------final-----)
    + [(4)\.创建一个对象用什么关键字？对象实例与对象引用有何不同？](#-4-----------------------------)
  * [4\.变量与方法](#4------)
    + [(1)\.成员变量与局部变量的区别有哪些](#-1-----------------)
    + [(2)\.在Java中定义一个不做事且没有参数的构造方法的作用](#-2---java---------------------)
    + [(3)\.在调用子类构造方法之前会先调用父类没有参数的构造方法，其目的是？](#-3----------------------------------)
    + [(4)\.一个类的构造方法的作用是什么？若一个类没有声明构造方法，改程序能正确执行吗？为什么？](#-4--------------------------------------------)
    + [(5)\.构造方法有哪些特性？](#-5------------)
    + [(6)\.静态变量和实例变量区别](#-6-------------)
    + [(7)\.静态变量与普通变量区别](#-7-------------)
    + [(8)\.静态方法和实例方法有何不同？](#-8----------------)
    + [(9)\.在一个静态方法内调用一个非静态成员为什么是非法的？](#-9---------------------------)
    + [(10)\.什么是方法的返回值？返回值的作用是什么？](#-10----------------------)
  * [5\.内部类](#5----)
    + [(1)\.什么是内部类？](#-1---------)
    + [(2)\.内部类的分类有哪些](#-2-----------)
    + [(3)\.内部类的优点](#-3--------)
    + [(4)\.内部类有哪些应用场景](#-4------------)
    + [(5)\.局部内部类和匿名内部类访问局部变量的时候，为什么变量必须要加上final？](#-5---------------------------------final-)
    + [(6)\.内部类相关，看程序说出运行结果](#-6-----------------)
  * [6\.重写与重载](#6------)
    + [(1)\.构造器（constructor）是否可被重写（override）](#-1------constructor--------override-)
    + [(2)\.重载（Overload）和重写（Override）的区别。重载的方法能否根据返回类型进行区分？](#-2-----overload-----override-----------------------)
  * [7\.对象相等判断](#7-------)
    + [(1)\.== 和 equals 的区别是什么](#-1-------equals-------)
    + [(2)\.hashCode 与 equals (重要)](#-2--hashcode---equals-----)
    + [(3)\.对象的相等与指向他们的引用相等，两者有什么不同？](#-3--------------------------)
  * [8\.值传递](#8----)
    + [(1)\.当一个对象被当作参数传递到一个方法后，此方法可改变这个对象的属性，并可返回变化后的结果，那么这里到底是值传递还是引用传递](#-1--------------------------------------------------------------)
    + [(2)\.为什么 Java 中只有值传递](#-2------java-------)
    + [(3)\.值传递和引用传递有什么区别](#-3---------------)
  * [9\.Java包](#9-java-)
    + [(1)\.JDK 中常用的包有哪些](#-1--jdk---------)
    + [(2)\.import java和javax有什么区别](#-2--import-java-javax-----)
- [四\.IO流](#--io-)
  * [1\.java 中 IO 流分为几种?](#1-java---io-------)
  * [2\.BIO,NIO,AIO有什么区别?](#2-bio-nio-aio------)
  * [3\.Files的常用方法都有哪些？](#3-files----------)
- [五\.反射](#----)
  * [1\.什么是反射机制？](#1---------)
  * [2\.反射机制优缺点](#2--------)
  * [3\.反射机制的应用场景有哪些](#3-------------)
  * [4\.Java获取反射的三种方法](#4-java---------)
- [六\.常用API](#----api)
  * [1\.String相关](#1-string--)
    + [(1)\.字符型常量和字符串常量的区别](#-1----------------)
    + [(2)\.什么是字符串常量池？](#-2------------)
    + [(3)\.String 是最基本的数据类型吗](#-3--string-----------)
    + [(4)\.String有哪些特性](#-4--string-----)
    + [(5)\.String为什么是不可变的吗？](#-5--string----------)
    + [(6)\.String真的是不可变的吗？](#-6--string---------)
    + [(7)\.是否可以继承 String 类](#-7---------string--)
    + [(8)\.String str="i"与 String str=new String(“i”)一样吗？](#-8--string-str--i---string-str-new-string--i------)
    + [(9)\.String s = new String(“xyz”);创建了几个字符串对象](#-9--string-s---new-string--xyz-------------)
    + [(10)\.如何将字符串反转？](#-10-----------)
    + [(11)\.数组有没有 length()方法？String 有没有 length()方法](#-11--------length-----string-----length----)
    + [(12)\.String 类的常用方法都有那些？](#-12--string------------)
    + [(13)\.在使用 HashMap 的时候，用 String 做 key 有什么好处？](#-13------hashmap-------string---key-------)
    + [(14)\.String和StringBuffer、StringBuilder的区别是什么？String为什么是不可变的](#-14--string-stringbuffer-stringbuilder-------string--------)
  * [2\.包装类相关](#2------)
    + [(1)\.自动装箱与拆箱](#-1---------)
    + [(2)\.int 和 Integer 有什么区别](#-2--int---integer------)
    + [(3)\.Integer a= 127 与 Integer b = 127相等吗](#-3--integer-a--127---integer-b---127---)
